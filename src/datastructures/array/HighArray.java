 ...
 * <p>
 * Compare to LowArray: abstraction level is higher and the client doesn't have to think about the index numbers. Set
 * and get methods are replaced by insert(), find() and delete() methods.
 */
