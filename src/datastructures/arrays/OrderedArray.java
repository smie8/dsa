...
/**
 * OrderedArray is a simple implementation of an ordered array.
 * It uses a linear search to insert elements in the correct order.
 *
...
public class OrderedArray {
  ...
  /**
   * Uses find to remove the value and shift the rest of the array.
   * Note that when
   */
